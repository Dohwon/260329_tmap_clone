...
const RAW_HIGHWAYS = [
  ...
  },
  {
    ...
    shortName: '2번국도',
    color: '#22C55E',
    startName: '전남 신안군 압해읍',
    endName: '부산광역시 해운대구 우동',
    startAddress: '전라남도 신안군 압해읍',
    endAddress: '부산광역시 해운대구 우동',
    startCoord: [34.8330, 126.3150],
    endCoord: [35.1632, 129.1635],
    totalKm: 487,
    majorJunctions: [
      { name: '목포', coord: [34.8118, 126.3926], km: 12 },
      { name: '순천', coord: [34.9500, 127.4875], km: 132 },
      { name: '하동', coord: [35.0676, 127.7511], km: 182 },
      { name: '진주', coord: [35.1800, 128.0800], km: 244 },
      { name: '부산 기장', coord: [35.2443, 129.2160], km: 460 },
    ],
    description: '목포권과 남해안, 부산 동부권을 잇는 남해안 동서축 국도',
  },
  {
    id: 'national3',
    roadClass: 'national',
  ...
  },
  {
    ...
    shortName: '5번국도',
    color: '#16A34A',
    startName: '충남 홍성군 홍북읍',
    endName: '경북 포항시 남구 대송면',
    startAddress: '충청남도 홍성군 홍북읍',
    endAddress: '경상북도 포항시 남구 대송면',
    startCoord: [36.6011, 126.6606],
    endCoord: [36.0140, 129.3850],
    totalKm: 334,
    majorJunctions: [
      { name: '청주', coord: [36.6422, 127.4890], km: 104 },
      { name: '문경', coord: [36.5860, 128.1870], km: 209 },
      { name: '단양', coord: [36.9840, 128.3650], km: 249 },
      { name: '영주', coord: [36.8174, 128.6240], km: 276 },
    ],
    description: '충청 내륙과 죽령, 경북 동부를 잇는 산악 종단 국도',
  },
  {
    id: 'national6',
    roadClass: 'national',
  ...
  },
  {
    ...
    shortName: '14번국도',
    color: '#4ADE80',
    startName: '경남 거제시 장승포동',
    endName: '울산광역시 북구 강동동',
    startAddress: '경상남도 거제시 장승포동',
    endAddress: '울산광역시 북구 강동동',
    startCoord: [34.8800, 128.6240],
    endCoord: [35.6250, 129.4420],
    totalKm: 183,
    majorJunctions: [
      { name: '부산 기장', coord: [35.2443, 129.2160], km: 121 },
      { name: '울산 정자', coord: [35.6290, 129.4420], km: 181 },
    ],
    description: '거제, 부산 기장, 울산 강동을 잇는 동남해안 해안 국도',
  },
  {
    id: 'national17',
    roadClass: 'national',
  ...
  },
  {
    ...
    shortName: '35번국도',
    color: '#10B981',
    startName: '경북 포항시 북구 흥해읍',
    endName: '전북 남원시 대산면',
    startAddress: '경상북도 포항시 북구 흥해읍',
    endAddress: '전북특별자치도 남원시 대산면',
    startCoord: [36.0690, 129.3310],
    endCoord: [35.4161, 127.3900],
    totalKm: 282,
    majorJunctions: [
      { name: '영덕', coord: [36.4152, 129.3656], km: 43 },
      { name: '봉화', coord: [36.8900, 128.7320], km: 127 },
      { name: '안동', coord: [36.5684, 128.7294], km: 168 },
      { name: '상주', coord: [36.4105, 128.1599], km: 216 },
    ],
    description: '동해안 울진·봉화 내륙을 지나 남원권까지 이어지는 산악 국도',
  },
  {
    id: 'national36',
    roadClass: 'national',
  ...
  },
  {
    ...
    shortName: '44번국도',
    color: '#22C55E',
    startName: '인천광역시 중구 운서동',
    endName: '강원특별자치도 양양군 양양읍',
    startAddress: '인천광역시 중구 운서동',
    endAddress: '강원특별자치도 양양군 양양읍',
    startCoord: [37.4602, 126.4407],
    endCoord: [38.0756, 128.6186],
    totalKm: 314,
    majorJunctions: [
      { name: '홍천', coord: [37.6943, 127.8884], km: 146 },
      { name: '인제', coord: [38.0690, 128.1700], km: 228 },
      { name: '미시령', coord: [38.1890, 128.4240], km: 261 },
      { name: '한계령', coord: [38.0720, 128.3740], km: 276 },
    ],
    description: '수도권 동부에서 설악권을 관통해 양양으로 이어지는 대표 산악 동서 국도',
  },
  {
    id: 'national45',
    roadClass: 'national',
  ...
  },
  {
    ...
    shortName: '59번국도',
    color: '#34D399',
    startName: '경남 통영시 도남동',
    endName: '강원특별자치도 홍천군 두촌면',
    startAddress: '경상남도 통영시 도남동',
    endAddress: '강원특별자치도 홍천군 두촌면',
    startCoord: [34.8273, 128.4297],
    endCoord: [37.8650, 128.0020],
    totalKm: 401,
    majorJunctions: [
      { name: '산청', coord: [35.4150, 127.8740], km: 112 },
      { name: '함양', coord: [35.5202, 127.7249], km: 139 },
      { name: '거창', coord: [35.6862, 127.9093], km: 176 },
      { name: '정선', coord: [37.3800, 128.6600], km: 328 },
    ],
    description: '지리산 동편과 강원 내륙 산악 지대를 종단하는 경관 국도',
  },
  {
    id: 'national416',
    roadClass: 'national',
    ...
    shortName: '416번국도',
    color: '#6EE7B7',
    startName: '강원특별자치도 인제군 북면',
    endName: '강원특별자치도 양구군 양구읍',
    startAddress: '강원특별자치도 인제군 북면',
    endAddress: '강원특별자치도 양구군 양구읍',
    startCoord: [38.0720, 128.3740],
    endCoord: [38.1107, 127.9895],
    totalKm: 61,
    majorJunctions: [
      { name: '해산령', coord: [38.1040, 128.2020], km: 22 },
      { name: '두타연 입구', coord: [38.2050, 128.0320], km: 44 },
    ],
    description: '인제와 양구를 잇는 해산령 산악 경관 국도',
  },
  {
    id: 'national77',
    roadClass: 'national',
